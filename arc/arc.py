...
class ARCSolver:
    ...
    def parse_grid_old(self, ids: List[int]):
    ...
    def text_grid(self, grid: List[List[int]]):
        coord_map = dict()
    ...
    def train(self, train_dataset, adapter_name=None, checkpoint=None):
        ...
        training_args = SFTConfig(
            ...
            per_device_train_batch_size=1, # set smaller when CUDA out of memory
            gradient_accumulation_steps=16, # set larger when CUDA out of memory
